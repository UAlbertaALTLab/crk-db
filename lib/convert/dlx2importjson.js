...
function convertEntry({
  ...
  senses = senses.map(({ definition, original, sources }) => {
    ...
    const semanticDefinition = createSemanticDefinition(definition, { i, isPronoun, literalMeaning });
...
function createSemanticDefinition(definition, { i, isPronoun, literalMeaning }) {
  ...
  if (i < 100 && semanticDefinition !== definition) {
    console.table({
      definition,
      semanticDefinition,
    });
