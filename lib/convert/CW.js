  ...
  constructor({
    ...
    rw_domains.forEach(domain => {
      if (domain.startsWith('h;')) {
        this.rw_domains.push(domain.substring(2).trim())
      } else {
        this.rw_domains.push(domain.trim())
      }
    })
    ...
    wn_domains.forEach(domain => {
      if (domain.startsWith('h;')) {
        this.wn_domains.push(domain.substring(2).trim())
      } else {
        this.wn_domains.push(domain.trim())
      }
    })
