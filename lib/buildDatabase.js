...
async function buildDatabase() {
  ...
  const aecdInputPath   = joinPath(dataDir, `AECD_crk2eng_ALTLab.tsv`);
  ...
  const generatorFSTPath = joinPath(__dirname, `../`, `generator-gt-dict-norm.hfstol`);
  ...
  await withSpinner(`AECD database import`, () => importAECD(aecdDataPath, databasePath,generatorFSTPath));
