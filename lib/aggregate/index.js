...
function aggregateEntry(entry) {
  ...
  if (
    entry.category.startsWith(`NA`) ||
    entry.category.startsWith(`NDA`) ||
    entry.category.startsWith(`NDI`) ||
    entry.category.startsWith(`NI`) ||
    entry.category.startsWith(`VAI`) ||
    entry.category.startsWith(`VII`) ||
    entry.category.startsWith(`VTA`) ||
    entry.category.startsWith(`VTI`)
  ) {

    entry.paradigm = entry.category;

  } else if (
    entry.category.startsWith(`PrA`) ||
    entry.category.startsWith(`PrI`)
  ) {
